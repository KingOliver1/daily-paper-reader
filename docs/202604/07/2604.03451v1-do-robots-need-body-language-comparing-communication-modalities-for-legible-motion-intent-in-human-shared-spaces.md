...
title_zh: 机器人需要肢体语言吗？人机共享空间中可理解运动意图的通信模态比较
...
tags: ["query:robot"]
score: 6.0
evidence: 四足机器人导航与运动意图传达
tldr: 本研究探讨了在共享空间中，机器人如何通过不同通信模态提高其运动意图的可解释性。研究人员以波士顿动力公司的Spot机器人为对象，通过在线视频实验对比了肢体语言（表达性运动）、灯光、文本和音频四种模态。实验涵盖四种常见导航场景，重点衡量了用户在预测机器人下一步行动时的准确性、置信度以及对机器人安全性的信任感。该研究为理解隐式与显式信号策略在人机交互中的相对有效性提供了初步证据。
selection_source: fresh_fetch
motivation: 机器人在共享空间中的运动往往难以被人类直观理解，导致人类需要承担适应机器人的负担。
method: 采用在线视频研究法，对比了四足机器人利用肢体语言、灯光、文本和音频等模态在四种导航场景下传达意图的效果。
result: 实验测量了不同模态对人类预测准确性、置信度和安全信任感的影响，并分析了多模态对齐或冲突时的用户反应。
conclusion: 研究提供了关于隐式与显式信号策略在提升机器人运动可读性方面相对有效性的初步证据。
---

## 摘要
在共享空间中，机器人的移动方式往往难以被人类理解，这使得适应的负担落在了人类身上。高自由度（High-DoF）机器人表现出的运动会被人们解读为具有表现力的，无论这种表现是有意还是无意的，因此理解这些线索如何被感知至关重要。我们提出了一项在线视频研究，评估不同的信号模态（表现力运动、灯光、文本和音频）如何影响人们理解四足机器人（波士顿动力公司的 Spot）即将进行的导航动作的能力。在四个常见场景中，我们衡量了每种模态如何影响人类（1）预测机器人下一步导航动作的准确性，（2）对该预测的信心，以及（3）对机器人安全行动的信任。该研究测试了表现力运动与显式通道的对比，一致的多模态线索是否能增强可解释性，以及冲突的线索如何影响用户的信心和信任。我们为隐式与显式信号策略的相对有效性提供了初步证据。
